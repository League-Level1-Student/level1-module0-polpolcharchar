...
if(guess.equalsIgnoreCase("arnold")) {
	...
	JOptionPane.showMessageDialog(null, "INCORRECT! That was Arnold!");
}
		...
		if(guess.equalsIgnoreCase("jack")) {
			...
			JOptionPane.showMessageDialog(null, "INCORRECT! That was Jack!");
		}
		showNextImage();
		...
		if(guess.equalsIgnoreCase("Leonardo")) {
			...
			JOptionPane.showMessageDialog(null, "INCORRECT! That was Leonardo!");
		}
		showNextImage();
		...
		if(guess.equalsIgnoreCase("Morgan")) {
			...
			JOptionPane.showMessageDialog(null, "INCORRECT! That was Morgan!");
		}
